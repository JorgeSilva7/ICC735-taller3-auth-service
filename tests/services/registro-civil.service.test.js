...
describe("getCriminalRecords", () => {
	it("should return a criminal records quantity=0 when request with 111111111", async () => {
		const rut = "111111111";
	...
	it("should return a criminal records quantity=1 when request with 777777777", async () => {
		const rut = "777777777";
